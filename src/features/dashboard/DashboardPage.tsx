...
export function DashboardPage() {
  ...
  return <section className="page">
    <div className="page-heading"><div><span className="eyebrow">POSICIÓN ACTUAL</span><h1>{selectedFarm ? `Administración ${selectedFarm.name}` : "Administración"}</h1><p>Hacienda y compromisos registrados.</p></div><button className="secondary-button dashboard-export" onClick={() => window.print()}><Download size={16}/>Exportar informe PDF</button></div>
